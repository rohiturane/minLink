    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                @if(empty($domain))
                <form action="{{url('/admin/domain/store')}}" method="post" enctype="multipart/form-data">
                @else
                <form action="{{url('/admin/domain/'.$domain->uuid.'/update')}}" method="post" enctype="multipart/form-data">
                @endif
                    @csrf
                    <div class="mb-3">
