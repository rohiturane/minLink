...
@section('content')
@include('frontend.layouts.common',['title' => 'Webp to JPG Converter'])
    ...
    <div class="row">
        <div class="p-4 col-lg-8 col-12">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="file" required name="image" accept="image/webp" class="form-control text-field">
                    </div>
            ...
            <div class="related_tools">
                {!! related_tools('3', 'Webp to JPG Converter') !!}
            </div>
        </div>
