...
@section('content')
@include('frontend.layouts.common',['title' => 'Youtube Hashtags Generator'])
    ...
    <div class="row">
        <div class="p-4 col-lg-8 col-12">
            <form>
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" required name="keywords" required value="{{ empty($_GET['keywords']) ? '' : $_GET['keywords']}}" class="form-control text-field">
                    </div>
                    <div class="col-md-12">
            ...
            <div class="related_tools">
                {!! related_tools('1', 'Youtube Hashtags Generator') !!}
            </div>
        </div>
