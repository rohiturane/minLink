...
@section('content')
@include('frontend.layouts.common',['title' => 'HTML Minifier'])
    ...
    <div class="row">
        <div class="p-4 col-lg-8 col-12">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        <label for="lang" class="form-label">Enter your HTML page</label>
            ...
            <div class="mt-3">
                <div class="mt-3 mb-3">
                    <label for="lang" class="form-label">Minified HTML</label>
                    <textarea class="form-control" rows="10" id="html_result">{{$data}}</textarea>
                </div>
                <button type="button" class="btn btn-sm bg-success text-white rounded-5 px-sm-3" onclick="copyToClipboard('html_result')">Copy to Clipboard</button>
