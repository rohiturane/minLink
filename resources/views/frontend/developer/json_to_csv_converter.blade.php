...
@section('content')
@include('frontend.layouts.common',['title' => 'JSON To CSV Converter'])
<div class="main-content bg-white mt-4" style="padding-left: 30px;">
    <div class="row">
        <div class="p-4 col-lg-8 col-12">
            ...
            <div class="mt-3">
                <div class="mt-3 mb-3">
                    <label for="lang" class="form-label">Converted CSV</label>
                    <textarea class="form-control" rows="10" id="csv_result">{{$data}}</textarea>
                </div>
                <button type="button" class="btn btn-sm bg-success text-white rounded-5 px-sm-3" onclick="copyToClipboard('csv_result')">Copy to Clipboard</button>
            ...
            <div class="related_tools">
                {!! related_tools('4','JSON To CSV Converter') !!}
            </div>
        </div>
