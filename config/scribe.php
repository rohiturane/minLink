...
return [
    ...
    'description' => config('app.name').' is license management system. It provide all basic information like Request Header information. ',
    ...
    'auth' => [
        ...
        'extra_info' => 'You can generate Access Token using Client ID from profile section and Project ID from project list.
